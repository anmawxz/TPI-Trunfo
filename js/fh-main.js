...
var cartaZed = {
    nome: "Zed",
    image: "../img/banco/fh/lamborghini.gif",
    atributos: {
        DanoFísico: 510,
        PoderMágico: 10,
        Armadura: 40
...
var cartaLulu = {
    nome: "Lulu",
    image: "../img/banco/fh/lamborghini2.gif",
    atributos: {
        DanoFísico: 60,
        PoderMágico: 80,
        Armadura: 65
...
var cartaEkko = {
    nome: "Ekko",
    image: "../img/banco/fh/mclaren.gif",
    atributos: {
        DanoFísico: 60,
        PoderMágico: 410,
        Armadura: 69
...
var cartaKayn = {
    nome: "Kayn",
    image: "../img/banco/fh/mclaren2.gif",
    atributos: {
        DanoFísico: 310,
        PoderMágico: 10,
        Armadura: 80
...
var cartaKennen = {
    nome: "Kennen",
    image: "../img/banco/fh/mercedes.gif",
    atributos: {
        DanoFísico: 50,
        PoderMágico: 239,
        Armadura: 45
...
var cartaKindred = {
    nome: "Kindred",
    image: "../img/banco/fh/mercedes2.gif",
    atributos: {
        DanoFísico: 320,
        PoderMágico: 25,
        Armadura: 25
...
var cartaYone = {
    nome: "Yone",
    image: "../img/banco/fh/mitsubishi.gif",
    atributos: {
        DanoFísico: 420,
        PoderMágico: 32,
        Armadura: 62
...
var cartaRekSai = {
    nome: "Rek'sai",
    image: "../img/banco/fh/nissan2.gif",
    atributos: {
        DanoFísico: 320,
        PoderMágico: 25,
        Armadura: 75
...
var cartaSuperTrunfo = {
    nome: "Teemo",
    image: "../img/banco/fh/porsche.gif",
    atributos: {
        DanoFísico: 1000,
        PoderMágico: 1000,
        Armadura: 1000
